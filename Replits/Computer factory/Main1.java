...
switch(cpu){
  case "i3": total+=150; break;
    case "i5": total+=250; break;
    case "i7": total+=350; break;
}
...
if (ram%4==0){
  total=total+(ram/4)*50;
    ...
    System.out.println("Select storage size:");
      ...
      switch (storage1){
        case "HDD": total=total+(storage2/500)*50;break;
           case "SSD": total=total+(storage2/500)*100;break;
      }
    ...
    System.out.println("Select screen resolution:");
      String resolution=input.nextLine();
        switch(resolution){
  case "FULLHD": total+=100; break;
    case "4K": total+=200; break;
}
